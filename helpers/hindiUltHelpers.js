/**
 * hindiUltHelpers.js - this is the code called by hindiUltParse.js to download and convert hindi ULT.
 */
...
//TODO: HI_ULT_URL path is a temporary repo, needs to be updated to final location.
const HI_ULT_URL = 'https://git.door43.org/photonomad0/AlignedUlb_hi/raw/master';

const ugntOutputPath = path.join('resources', 'hi', 'bibles', 'ult');
...
export function generateVersion(version, resolve, index=true) {
  ...
  UsfmParseHelpers.parseUsfmToChapters(HI_ULT_URL, version, books, 'hi-ult-sources', ugntOutputPath, () => {
    if (index) {
