...
const RESOURCE_ID = process.argv[3].toLowerCase(); // ex. ult, udt, ust, ugnt, tw, tn, ta
// constants
const RESOURCE_KEY = stringsHelper.getResourceId(RESOURCE_ID); // ex. ult, udt, ust, ugnt, translatioWords, translationNotes, translationAcademy
