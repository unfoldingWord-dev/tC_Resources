...
describe('Zip Helpers', () => {
  ...
  test('extractZipFile with valid input', () => {
    ...
    zipfilepath = path.join('.', '__tests__', 'output', zipFileName);
    fs.copySync(path.join('.', '__tests__', 'fixtures', zipFileName), zipfilepath); // copy zip to new location since it will be deleted
